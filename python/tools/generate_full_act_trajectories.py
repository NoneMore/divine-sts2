...
# Make the acceptance package importable when this file is run directly.
...
from tests.acceptance.full_act_bridge_acceptance import select_policy_action
...
def export_trajectories(num_workers: int = 4, runs_per_worker: int = 5) -> int:
    ...
    output_dir = REPOSITORY_ROOT / "artifacts" / "trajectories"
    output_dir.mkdir(parents=True, exist_ok=True)
