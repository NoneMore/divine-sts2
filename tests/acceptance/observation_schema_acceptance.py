...
first, then `python tests/acceptance/observation_schema_acceptance.py`).
"""
...
from tools.run_seeded_full_act_corpus import choose_action as choose_full_act_action
from tools.run_seeded_full_act_corpus import scenario as full_act_scenario

FIXTURE_PATH = REPOSITORY_ROOT / "tests" / "fixtures" / "canonical-observations.json"
